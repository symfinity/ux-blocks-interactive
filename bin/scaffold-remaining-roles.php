...
function scaffoldMenu(string $role, string $component, string $controllerSlug, array $nested = ['Trigger', 'Content', 'Item']): void
{
    ...
    writeFile(
        "{$src}/{$component}.php",
        phpClass($component, $component, "@UxBlocksInteractive/components/{$component}.html.twig"),
    );
    writeFile(
...
<div
    data-ui-role="{$kebab}"
    data-ui-fragment="blocks.int.{$kebab}"
...
TWIG,
    ...
    foreach ($nested as $part) {
        ...
        writeFile(
            "{$src}/{$class}.php",
            phpClass($class, $twigPart, "@UxBlocksInteractive/components/{$component}/{$part}.html.twig"),
        );
...
<{$rootTag}
    data-ui-role="{$role}"
    data-ui-fragment="blocks.int.{$role}"
    data-controller="{$ctrl}"
    {$extraAttrs}
    {{ attributes }}
>
...
writeFile("{$src}/Calendar.php", phpClass('Calendar', 'Calendar', '@UxBlocksInteractive/components/Calendar.html.twig'));
...
writeFile("{$src}/InputOtp.php", phpClassWithProps('InputOtp', 'InputOtp', '@UxBlocksInteractive/components/InputOtp.html.twig', "    public int \$length = 6;\n"));
...
writeFile("{$src}/{$component}.php", phpClass($component, $component, "@UxBlocksInteractive/components/{$component}.html.twig"));
writeFile("{$tpl}/{$component}.html.twig", <<<TWIG
<div
...
writeFile("{$src}/Toast.php", phpClass('Toast', 'Toast', '@UxBlocksInteractive/components/Toast.html.twig'));
...
writeFile("{$src}/CommandPalette.php", phpClassWithProps(
    'CommandPalette',
    'CommandPalette',
    '@UxBlocksInteractive/components/CommandPalette.html.twig',
