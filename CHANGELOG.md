...
All changes to **symfinity/ux-blocks-interactive** are currently on `main` (unreleased, untagged).

## [Unreleased]

### Added

- **046 R2:** `DateRangePicker`, `TagsInput`, and `TreeView` roles (`blocks.int.*` fragments + Stimulus)
...
- Symfony bundle `SymfinityUxBlocksInteractiveBundle` for integration
- Module `Controller`
- Module `Twig`
