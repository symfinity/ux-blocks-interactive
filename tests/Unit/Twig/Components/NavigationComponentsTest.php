...
final class NavigationComponentsTest extends ComponentTestCase
{
    ...
    {
        return [
            'menubar' => ['Menubar', 'menubar', 'blocks.int.menubar', 'menubar', []],
            'navigation-menu' => ['NavigationMenu', 'navigation-menu', 'blocks.int.navigation-menu', 'navigation-menu', []],
            'sidebar' => ['Sidebar', 'sidebar', 'blocks.int.sidebar', 'sidebar', ['side' => 'left']],
            'stacked-layout-interactive' => [
                'StackedLayoutInteractive',
                'stacked-layout-interactive',
                'blocks.int.stacked-layout-interactive',
                'stacked-layout-interactive',
